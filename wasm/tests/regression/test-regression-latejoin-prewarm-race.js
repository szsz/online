...
(async () => {
    ...
    // openSecretInBrowser + two-tab helpers re-resolve the active iframe
    // on every poll, surviving the viewer's mid-test replaceChild of
    // #editor-frame (cold-reload / hot-switch).
    ...
    const ccC = await getCharCount(pC);
